...
<main class="min-h-screen bg-white font-serif">
	<section class="max-w-5xl mx-auto px-4 sm:px-8 pt-10 pb-16">
		<h1 class="text-2xl sm:text-3xl font-semibold text-center tracking-wide mb-6">
			ABOUT US
		</h1>
